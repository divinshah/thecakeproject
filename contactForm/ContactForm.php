...
class ContactForm
{
    ...
    public function addContactForm($f_name, $l_name, $phone_number, $email, $city, $category, $message, $db){
        $sql = "INSERT INTO contact_form (f_name,l_name,phone_number, email, city, message )
                VALUES (:f_name, :l_name, :phone_number, :email, :city, :message)";
        $pst = $db->prepare($sql); 
