  ...
  <ul class="nav nav-tabs">
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="faq/addFaq.php">Add FAQ</a>
        <a class="dropdown-item" href="faq/listfaqs.php">List FAQS</a>
    </li>
	
	<li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Contact Forms</a>
      <div class="dropdown-menu">
        <a class="dropdown-item" href="contactForm/listContactForm.php">List Forms</a>
    </li>
 </ul>
